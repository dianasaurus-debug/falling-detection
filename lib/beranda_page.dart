...
//store file in documents folder
        ...
        Directory appDocumentsDirectory = (await getExternalStorageDirectories(type: StorageDirectory.downloads))!.first; // 1
        File f = new File("${appDocumentsDirectory.path}/datasample.csv");
        // gabungan.add(rows);
